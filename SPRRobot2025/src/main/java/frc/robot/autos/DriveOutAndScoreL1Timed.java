...
public class DriveOutAndScoreL1Timed extends Command {
     ...
     * @param arm
     */
    public DriveOutAndScoreL1Timed(DriveSubsystem drive, RollerSubsystem roller, ArmSubsystem arm)
    {
        m_drive = drive;
        m_roller = roller;
        m_arm = arm;
  ...
  public void execute() {
    ...
    else if(timer.get() > drive_seconds && timer.get() < exjest_seconds)
    {
        ...
        m_roller.runRoller(RollerConstants.ROLLER_EJECT_VALUE);
    }
  }
